...
const serviciosAdministrativos = [
  ...
  { icon: 'M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z', title: 'División de Fortalecimiento y Supervisión de la Gestión Educativa (DFSGE)', desc: 'La DFSGE fundamenta su accionar en un conjunto de leyes, decretos, normativas, manuales y lineamientos técnicos emanados del Ministerio de Educación (MINERD), que regulan los procesos de supervisión, monitoreo, acompañamiento, evaluación y control de la calidad educativa en los 6 Distritos de la Dirección Regional 15.' },
