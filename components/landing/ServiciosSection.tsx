  ...
  return (
    <section id="servicios" ref={sectionRef} className="section services-section" aria-label="Servicios, programas, enlaces y catálogos">
      <div className="container">
        ...
        <div className="catalogos-banner animate-on-scroll" role="region" aria-label="Catálogos de servicios disponibles">
          <div className="catalogos-banner-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
          </div>
          <div className="catalogos-banner-text">
            <span className="catalogos-banner-badge">Nuevo</span>
            <h3>Tenemos Catálogos de Servicios</h3>
            <p>Consulta todos los catálogos de cada departamento y descubre los servicios que la Regional 15 pone a tu disposición, junto a manuales y documentos institucionales.</p>
          </div>
          <button type="button" className="catalogos-banner-btn" onClick={() => setActiveTab('catalogos')}>
            Ver catálogos
